...
# assemble_table.tab
# quality_table.tab
# primers-uv_table.tab
# primers-uc_table.tab
# primers-v_table.tab
# primers-c_table.tab
# align_table.tab
# consensus_table.tab
# final_headers.tab
# final-unique_headers.tab
# final-unique-atleast2_headers.tab
...
```{r mids, child="Paired-MIDs.Rmd", eval=chunkEval()}
```

```{r primers, child="Paired-Primers.Rmd", eval=chunkEval()}
```

```{r align, child="Single-Align.Rmd", eval=FALSE}
```

```{r consensus, child="Single-Consensus.Rmd", eval=chunkEval()}
```
