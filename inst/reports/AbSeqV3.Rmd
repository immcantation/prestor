...
```{r assemble, child="Consensus-Assembly.Rmd", eval=chunkEval()}
```

```{r cregion, child="Consensus-CRegion.Rmd", eval=chunkEval()}
```
 
```{r headers, child="Consensus-Headers.Rmd", eval=chunkEval()}
```