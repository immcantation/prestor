...
figures("cons_prfreq", "Histograms showing the distribution of majority primer frequency 
                        for all UMI read groups.")
figures("cons_prsize", "Violin plots showing the distribution of UMI read group sizes by 
                        majority primer. Only groups with majority primer frequency 
...
```{r, echo=FALSE}
plotBuildConsensus(consensus_log, titles=c("Consensus"), 
